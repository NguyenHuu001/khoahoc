    ...
    return (
        <div className={s('wrap_baner', 'p-0')}>
            <div className={s('baner_one','d-flex','justify-content-center')}>
                <div className={s('content_baner_one', 'col-md-6','d-flex','flex-column','align-items-center')}>
                    <h1 className={s('pb-5','pt-5')}>Khởi đầu sự nghiệp của bạn</h1>
                    <h1 className={s('pb-5')}>Trở thành lập trình viên chuyên nghiệp tại BSMART</h1>
                    <span className={s('pb-5')}>
