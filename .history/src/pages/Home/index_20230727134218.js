    ...
    return (
        <div className={s('wrap_baner', 'p-0')}>
            ...
            <div className={s('wrapper')}>
                ...
                <div class="item_count col-sm-4 col-md-12 col-lg-4">
                                <div class="cart border shadow">
                                    <img class="cart-img-top rounded-top" style="width: 100%; height: 200px;"
                                        src="img/item_net_core.jpg" alt=".NET">
                                    <div class="cart-body ps-2 pe-2 cart-body_cusor">
                                        <h4 class="align-self-center cart_title mt-5 fw-bolder title_h4">
                                            .NET Core API
                                        </h4>
                                        <img src="img/icon-title-course.png" alt=""/>
                                        <a href="#" class="name_GV text-decoration-none d-flex">
                                            <p class="ms-1 fw-semibold">Mentor </p>
                                            <p class="ms-2 fw-semibold">Trần Hữu Hiệp</p>
                                        </a>
                                        <div class="d-flex ">
                                            <i class="fa-solid fa-user mt-1"></i>
                                            <p class="fw-bolder ms-2 fst-italic">104 Học Viên</p>
                                        </div>
                                        <div class="detail fw-semibold">
                                            .NET Core API là một framework được tạo ra bởi Microsoft để xây dựng các
                                            ứng dụng web API và microservices. Nó được thiết kế để hỗ trợ việc phát
                                            triển ứng dụng
                                            đa nền tảng, cho phép các nhà phát triển xây dựng ứng dụng trên nhiều nền
                                            tảng như
                                            Windows, macOS và Linux. Ứng dụng được phát triển bằng .NET Core API có thể
                                            hoạt động
                                            trên các nền tảng khác nhau một cách dễ dàng và không cần phải thực hiện các
                                            thủ tục
                                            phức tạp để chỉnh sửa mã nguồn.
                                        </div>
                                        ...
                                        <div class="wrap_price d-flex mt-2">
                                            <p class="price fw-bold mb-0 ">3,000,000 VND</p>
                                            <i class="fa-solid fa-calendar-days mt-1 ms-2"></i>
                                            <p class="fw-bolder mb-0 ms-2">25 Buổi Học</p>
                                        </div>
                                        <div class="border-bottom border-grey mb-3 mt-2"></div>
                                        <div class="p-3 mb-5 rounded button-ct text-uppercase" type="button">Xem chi
                                            tiết</div>
                                    </div>
                                </div>
                            </div>
