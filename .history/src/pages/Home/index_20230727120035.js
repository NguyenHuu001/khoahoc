        ...
        <div className={s('wrap_baner', 'p-0')}>
            <div className={s('wrap_header')}>
                <div className={s('baner')}>
                    <div className={s('content_header','d-flex','flex-column','align-items-center','mb-5')}>
                        <h1 className={s('fs-1','content_title','mb-5','mt-5')}>Khởi đầu sự nghiệp của bạn</h1>
                        <h1 className={s('fs-1','content_title_two','mb-5','mt-5')}>Trở thành lập trình viên chuyên nghiệp tại BSMART</h1>
