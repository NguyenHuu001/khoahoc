...
function Home() {
    return (
        <div className={s('wrap_baner', 'p-0')}>
            ...
            <div className={s('container-fluid','align-items-center', 'd-flex', 'col-md-12', 'col-sm-12', 'col-xs-12')}>
                <div className={s('baner_two')}>
                    <div className={s('container-fluid','p-0', 'col-md-12', 'col-sm-12', 'col-xs-12')}>
