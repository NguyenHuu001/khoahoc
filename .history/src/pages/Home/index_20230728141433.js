        ...
        <div className={s('wrap_baner', 'p-0', 'col-md-12', 'col-xs-12')}>
            ...
            <div className={s('container-fluid')}>
                <div className={s('footer_wrap')}>
                    <div className={s('container')}>
                        <div className={s('row','d-flex')}>
                            <div className="col-sm-5 col-xs-12 col-lg-3 mt-5 p-0 ps-3">
                                <img className="mb-5 " src="img/sv_logo_dashboard.png" alt="" />
                                <p className="text-white mb-5 text-wrap">
                                ...
                                <h5 className="text-white mb-2">Theo dõi chúng tôi tại:</h5>
                                <div className="wrap_icon mb-5 ">
                            ...
                            <div className="col-sm-2 col-xs-5 col-lg-2 mt-5 p-0 ps-3">
                                <h5 className="title_h5 ">Menu</h5>
                                <ul className="ps-0 mt-3 fw-normal ">
                                    <a className="text-decoration-none text-white" href="#">
                                        <li className="mt-2">Trang chủ</li>
                                    </a>
                                    <a className="text-decoration-none text-white" href="#">
                                        <li className="mt-2">Về chúng tôi</li>
                                    </a>
                                    <a className="text-decoration-none text-white" href="#">
                                        <li className="mt-2">Nền tảng LMS</li>
                                    </a>
                                    <a className="text-decoration-none text-white" href="#">
                                        <li className="mt-2">Khóa học STEM</li>
                                    </a>
                                    <a className="text-decoration-none text-white" href="#">
                                        <li className="mt-2">Khóa học</li>
                                    </a>
                                    <a className="text-decoration-none text-white" href="#">
                                        <li className="mt-2">Mentor</li>
                                    </a>
                                    <a className="text-decoration-none text-white" href="#">
                            ...
                            <div className="col-sm-2 col-xs-2 mt-5 col-lg-2 ms-0 p-0 ps-3">
                                <h5 className="title_h5 ">Điều khoản</h5>
                                <ul className="ps-0 mt-3 fw-normal">
                                    <a className="text-decoration-none text-white" href="#">
                                        <li className="mt-2">Chính sách bảo mật</li>
                                    </a>
                                    <a className="text-decoration-none text-white" href="#">
                                        <li className="mt-2">Điều khoản dịch vụ</li>
                                    </a>
                                </ul>
                                <h5 className="title_h5  mt-5">Cộng tác viên</h5>
                                <ul className="ps-0 mt-3 fw-normal ">
                                    <a className="text-decoration-none text-white" href="#">
                                        <li className="mt-2">Đăng ký Cộng tác viên</li>
                                    </a>
                                    <a className="text-decoration-none text-white" href="#">
                                        <li className="mt-2">Đăng ký Mentor</li>
                                    </a>
                                </ul>
                            </div>
                            <div className="col-sm-4 col-xs-3 mt-5 col-lg-4 p-0 ps-3">
                                <h5 className="title_h5">Liên hệ với chúng tôi</h5>
                                <div className="text-white d-flex ">
                                    <i className="icon_info fa-solid fa-location-dot mt-1"></i>
                                    <p className="fw-normal ms-2">Tân Phú, TP.HCM</p>
                                </div>
                                <div className="text-white d-flex ">
