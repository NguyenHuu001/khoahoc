        ...
        <div className={s('wrap_baner', 'p-0')}>
            <div className={s('wrap_header')}>
                <div className={s('baner','d-flex','justify-content-center')}>
                    <div className={s('content_header','d-flex','flex-column','align-items-center','mb-5','col-md-10','col-sm-10')}>
                        ...
                        <span className={s('fs-3','content_content','mb-5','mt-5','col-md-10')}>
                        ...
                        <div>
                            <button className={s('fs-2','content_button','mt-5')}>Xem khóa học</button>
                        </div>
                    </div>
                </div>
            </div>
