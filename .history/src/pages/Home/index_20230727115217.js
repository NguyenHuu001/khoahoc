        ...
        <div className={s('wrap_baner', 'p-0')}>
            <div className={s('wrap_header')}>
                <div className={s('baner')}>
                    {/* <div className={s('content_header','d-flex','flex-column','align-items-center')}>
                        <h1 className={s('fs-1','content_title')}>Khởi đầu sự nghiệp của bạn</h1>
                        <h1 className={s('fs-1','content_header')}>Trở thành lập trình viên chuyên nghiệp tại BSMART</h1>
                        <span className={s('fs-3','content_content')}>
                        ...
                        <div>
                            <button className={s('fs-3','content_button')}>Xem khóa học</button>
                        </div>
                    </div> */}
                </div>
            </div>
