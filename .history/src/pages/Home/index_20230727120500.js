            ...
            <div className={s('wrap_header')}>
                <div className={s('baner','d-flfex')}>
                    <div className={s('content_header','d-flex','flex-column','align-items-center','mb-5')}>
                        ...
                        <h1 className={s('content_title_two','mb-5','mt-3')}>Trở thành lập trình viên chuyên nghiệp tại BSMART</h1>
                        <span className={s('fs-4','content_content','mb-5','mt-5')}>
                        ...
                        <div>
                            <button className={s('fs-2','content_button','mb-5','mt-5')}>Xem khóa học</button>
                        </div>
                    </div>
                </div>
            </div>
