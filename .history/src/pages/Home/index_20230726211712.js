...
function Home() {
    return (
        <div className={s('wrap_baner', 'p-0')}>
            <div
                className={s('baner', 'd-flex', 'justify-content-center', 'col-md-12', 'col-sm-12','col-xs-12')}
                style={{ backgroundImage: `url(${baner})` }}
            >
                <div className={s('baner_content', 'd-flex', 'flex-column', 'align-items-center', 'col-md-12','col-xs-12', 'p-5', 'col-sm-12')}>
                    <div className={s('wrap_content', 'd-flex', 'flex-column', 'align-items-center', 'col-md-12', 'col-sm-12')}>
