        ...
        <div className={s('wrap_baner', 'p-0', 'col-md-12', 'col-xs-12')}>
            ...
            <div className={s('wrapper')}>
                ...
                <div className={s('container', 'd-flex', 'justify-content-between', 'hiden')}>
                    <div className={s('item_count', 'me-1', 'p-4', 'col-md-12', 'col-md-12','col-xs-10', 'ps-0', 'pe-0')}>
                        <Slider {...settings}>
                            {/* Item1 */}
                            <div className={s('col-md-3', 'p-3')}>
                                <div className={s('col-md-12','col-xs-11', 'border', 'shadow')}>
                                    <img
                                        className={s('cart-img-top', 'rounded-top', 'col-md-12','col-xs-5')}
                                        src={anh}
                                        alt=".NET"
                                    />
