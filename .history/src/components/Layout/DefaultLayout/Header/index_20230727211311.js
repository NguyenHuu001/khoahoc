...
function Header() {
    return (
        <>
            ...
            {/* // Header */}
            <div className={s('Header', ' container-fluid', 'justify-content-between', 'fixed-top', ' shadow ','bg-white')}>
                <div className={s('container', 'd-flex', 'justify-content-between', 'mt-5', 'col-xs-10','col-sm-12', 'p-0')}>
                    {/* <!-- Header  --> */}
                    <div>
