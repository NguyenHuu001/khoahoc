        ...
        <div className={s('wrap_baner', 'p-0')}>
            ...
            <div className={s('wrapper')}>
                <div className={s('carousel')}>
                    <div className="item_count col-sm-4 col-md-12 col-lg-4">
                        <div className="cart border shadow">
                            <img
                                className="cart-img-top rounded-top"
                                // style="width: 100%; height: 200px;"
                                src="img/item_net_core.jpg"
                                alt=".NET"
                            />
                            <div className="cart-body ps-2 pe-2 cart-body_cusor">
                                <h4 className="align-self-center cart_title mt-5 fw-bolder title_h4">.NET Core API</h4>
