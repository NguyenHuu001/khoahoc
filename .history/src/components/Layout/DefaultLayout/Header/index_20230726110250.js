            ...
            <div className={s('coating')}>
                <div className={s('sidebar_content')}>
                    ...
                    <div className={s('sidebar_menu ')}>
                        <ul>
                            <li className={s('text','text-uppercase', 'pt-3', 'fw-bolder')}>Trang chủ</li>
                            <li className={s('text','text-uppercase', 'pt-3', 'position-relative', 'fw-bolder')}>
                                ...
                                <ul className={s('ps-4', 'ul_down')}>
                                    <li className={s('text','text-uppercase', 'pt-3')}>Câu chuyện founder</li>
                                    <li className={s('text','text-uppercase', 'pt-3')}>Nền tảng lms</li>
                                </ul>
                            </li>
                            <li className={s('text','text-uppercase', 'pt-3', 'fw-bolder')}>Khóa học stem</li>
                            <li className={s('text','text-uppercase', 'pt-3', 'fw-bolder')}>Khóa học</li>
                            <li className={s('text','text-uppercase', 'pt-3', 'fw-bolder')}>mentor</li>
                            <li className={s('text','text-uppercase', 'pt-3', 'fw-bolder')}>blog</li>
                        </ul>
                    </div>
