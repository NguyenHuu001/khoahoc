                        ...
                        <div class="container ">
                            <div class="row d-flex justify-content-between">
                                <div class="col-sm-5 col-xs-12 col-lg-3 mt-5 p-0 ps-3">
                                    ...
                                    <p class="text-white mb-5 text-wrap">
                                        Chúng tôi cung cấp các khoá học chất lượng cao để cải thiện các kỹ năng lập
                                        trình của bạn. Tất cả các mentor của chúng tôi đều có nhiều kinh nghiệm trong
                                        thực tế và giảng dạy.
                                    </p>
                                    <h5 class="text-white mb-2">Theo dõi chúng tôi tại:</h5>
                                    <div class="wrap_icon mb-5 ">
                                        <a class="me-2" href="#">
                                            <i class="fa-brands fa-facebook" style="color: #eff0f0;"></i>
                                        </a>
                                        <a class="me-2" href="">
                                            <i class="fa-brands fa-square-instagram" style="color: #fcfcfd;"></i>
                                        </a>
                                        <a class="me-2" href="#">
                                            <i class="fa-brands fa-youtube" style="color: #fcfcfc;"></i>
                                        </a>
                                    </div>
                                </div>
