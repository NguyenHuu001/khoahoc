...
function Home() {
    window.onload = () => {
        const carouselSlide = document.querySelector('.hiden');
        const carouselImages = document.querySelectorAll('.item_count');
        ...
        function slideCarousel() {
          ...
          carouselSlide.styles.transform = `translateX(${-currentIndex * 100}%)`;
        }
