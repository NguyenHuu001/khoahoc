                ...
                <div className={s('sidebar_content')}>
                    ...
                    <div className={s('sidebar_menu ')}>
                        <ul>
                            ...
                            <li className={s('text-uppercase')}>Khóa học stem</li>
                            <li className={s('text-uppercase')}>Khóa học</li>
                            <li className={s('text-uppercase')}>mentor</li>
                            <li className={s('text-uppercase')}>blog</li>
                        </ul>
                    </div>
