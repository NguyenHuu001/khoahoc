    ...
    return (
        <div className={s('wrap_baner', 'p-0')}>
            ...
            <div className={s('container-fluid', 'wrap_baner', 'p-0')}>
                <div className={s('baner_two','align-items-center','d-flex')} style={{ background: `url(${background})` }}>
                    <div className={s('container')}>
                        <div className={s('row', 'content_two')}>
                            <div className={s('col-sm-6','d-flex','justify-content-center','flex-column')}>
                            ...
                            <div className={s('img_baner','col-sm-6')}>
                                <div style={{background: `url(${baner2})`}}></div>
                            </div>
                        </div>
                    </div>
                </div>
