                    ...
                    <div className={s('container')}>
                        ...
                        <div className={s('row')}>
                            <div className={s('col-sm-4')}>
                                <h3 className={s('fw-bolder' vanta)}>Học theo lộ trình, có định hướng</h3>
                            ...
                            <div className={s('col-sm-4')}>
                                <h3 className={s('fw-bolder' vanta)}>Nền tảng cốt lõi trong lập trình</h3>
                                <p className={s('vantage_content')}>
                            ...
                            <div className={s('col-sm-4')}>
                                <h3 className={s('fw-bolder' vanta)}>Mài giũa bạn qua thực tế</h3>
                                <p className={s('vantage_content')}>
                        ...
                        <div className={s('row')}>
                            <div className={s('col-sm-4')}>
                                <h3 className={s('fw-bolder' vanta)}>Mentor tận tâm</h3>
                                <p className={s('vantage_content')}>
                            ...
                            <div className={s('col-sm-4')}>
                                <h3 className={s('fw-bolder' vanta)}>Công nghệ mới, thực tế</h3>
                                <p className={s('vantage_content')}>
                            ...
                            <div className={s('col-sm-4')}>
                                <h3 className={s('fw-bolder' vanta)}>Trao tay chìa khóa thành công</h3>
                                <p className={s('vantage_content')}>
