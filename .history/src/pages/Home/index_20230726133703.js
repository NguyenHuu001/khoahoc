...
function Home() {
    return (
        <div className={s('wrap', 'container-fluid','container-lg','container-md','container-sm')}>
            <div className={s('baner','d-flex','justify-content-center','container-fluid')} style={{ backgroundImage: `url(${baner})` }}>
                <div className={s('baner_content', 'd-flex', 'flex-column','align-items-center')}>
                    <div className={s('wrap_content', 'd-flex', 'flex-column', 'align-items-center')}>
                        ...
                        <h1 className={s('content_two','col-sm-12')}>Trở thành lập trình viên chuyên nghiệp tại BSMART</h1>
