    ...
    return (
        <div className={s('wrap_baner', 'p-0','col-md-12','col-xs-12')}>
            <div className={s('baner_one','d-flex','justify-content-center')}>
                <div className={s('content_baner_one', 'col-md-5','col-xs-12','d-flex','flex-column','align-items-center')}>
                    <h1 className={s('pb-5','pt-5','title_top')}>Khởi đầu sự nghiệp của bạn</h1>
                    <h1 className={s('pb-5','title_two')}>Trở thành lập trình viên chuyên nghiệp tại BSMART</h1>
                    <span className={s('pb-5','content_content')}>
                    ...
                    <div className={s('container', 'col-md-12', 'col-sm-12', 'col-xs-12')}>
                        ...
                        <div className={s('row', 'content_two', 'pb-5')}>
                            <div className={s('col-sm-12', 'col-md-6')}>
                                ...
                                <div className={s('d-flex', 'justify-content-center', 'mt-5','col-md-6')}>
                                    <button className={s('fw-bolder', 'content_two_btn','p-5')}>Xem khóa học</button>
                                    <button className={s('fw-bolder', 'content_two_btn','p-5')}>Hỗ trợ tư vấn</button>
                                </div>
                            </div>
