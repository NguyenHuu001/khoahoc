        ...
        <div className={s('wrap_baner', 'p-0', 'col-md-12', 'col-xs-12')}>
            ...
            <div className={s('wrapper')}>
                ...
                <div className={s('container', 'd-flex', 'justify-content-between', 'hiden')}>
                    <div className={s('item_count', 'me-1', 'p-4', 'col-md-12')}>
                        <Slider {...settings}>
                            {/* Item1 */}
                            <div className={s('cart', 'col-md-3','col-sx-12')}>
                                <div className={s('col-md-11','col-sx-12','p-3','border','shadow')}>
                                    <img className={s('cart-img-top', 'rounded-top', 'col-md-12','col-sx-12')} src={anh} alt=".NET" />
                                    <div className={s('cart-body', 'ps-3', 'pe-3', 'cart-body_cusor')}>
                                        ...
                                        <div className={s('detail', 'fw-semibold')}>
                                            ...
                                            dụng web API và microservices. Nó được thiết kế để hỗ trợ việc phát triển ứng
                                            dụng đa nền tảng, cho phép các nhà phát triển xây dựng ứng dụng trên nhiều nền
                                            tảng như Windows, macOS và Linux. Ứng dụng được phát triển bằng .NET Core API có
                                            thể hoạt động trên các nền tảng khác nhau một cách dễ dàng và không cần phải
                                            thực hiện các thủ tục phức tạp để chỉnh sửa mã nguồn.
                                        </div>
                            ...
                            {/* ---- */}
                            <div className={s('cart', 'col-md-3')}>
                                <div className={s('col-md-11','p-3','border','shadow')}>
