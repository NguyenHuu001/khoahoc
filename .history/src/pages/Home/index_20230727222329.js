            ...
            <div className={s('wrapper')}>
                ...
                <div className={s('container', 'd-flex', 'justify-content-between', 'hiden')}>
                    <div className={s('item_count', 'me-1', 'p-4', 'col-md-12')}>
                        <Slider {...settings}>
                            {/* Item1 */}
                            <div className={s('cart', 'col-md-3','col-xs-12')}>
                                <div className={s('col-md-11','col-xs-12','p-3','border','shadow')}>
                                    <img className={s('cart-img-top', 'rounded-top', 'col-md-12','col-xs-12')} src={anh} alt=".NET" />
