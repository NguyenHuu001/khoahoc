        ...
        <div className={s('wrap_baner', 'p-0', 'col-md-12', 'col-xs-12')}>
            ...
            <div className={s('baner_two')}>
                ...
                >
                    <div className={s('container', 'col-md-12', 'col-sm-12', 'col-xs-12')}>
                        <h1 className={s({s('text-center')}, 'mb-5', 'about_us')}>Về chúng tôi</h1>
            ...
            <div className={s('container-fluid', 'vantage_Point', 'p-0')}>
                <div className={s('container')}>
                    <h1 className={s({s('text-center')}, 'mb-5', 'vantage_title', 'mt-5')}>Điểm ưu việt tại BSmart</h1>
            ...
            <div className={s('advantages','container-fluid')}>
                <div className={s('container')}>
                    <div className={s('advantages-content')}>
                        <h4 className={s('text-center')}>Định hướng và Chuẩn hoá lộ trình học tập</h4>
                        <h2 className={s('text-center')}>Học Thật, Dự Án Thật, Mentor Tận Tâm</h2>
                        <div className={s('d-flex','justify-content-center')}>
                            <a href="#" className={s('btn btn-primary-custom-select m-2')}>
                            <button className="btn btn-outline-secondary-custom m-2">Danh sách khóa học</button>
                            </a>

                            <a href="#">
                                <button className="btn btn-outline-secondary-custom m-2">Tư vấn lộ trình</button>
                            </a>
                        </div>
                    </div>
                </div>
