...
function Home() {
    ...
    return (
        <div className={s('wrap_baner', 'p-0', 'col-md-12', 'col-xs-12')}>
            ...
            <div className={s('wrapper_two')}>
                <div className={s('d-flex', 'justify-content-center')}>
                    <h1 className={s('fw-bolder', 'tiltle_khoahoc')}>
                        Nhận được sự tin tưởng của các đối tác logo đại học hợp tác cùng BSmart; logo đại học Văn Lang
                        logo đại học hợp tác cùng BSmart; logo VSM logo đại học hợp tác cùng BSmart; logo đại học Hutech
                    </h1>
                </div>
                <div className={s('container', 'd-flex', 'justify-content-between', 'hiden', 'pb-5')}>
                    <div
