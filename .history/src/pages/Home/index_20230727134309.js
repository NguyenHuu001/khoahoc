                ...
                <div className={s('carousel')}>
                    <div class="item_count col-sm-4 col-md-12 col-lg-4">
                        <div class="cart border shadow">
                            <img
                                class="cart-img-top rounded-top"
                                // style="width: 100%; height: 200px;"
                                src="img/item_net_core.jpg"
                                alt=".NET"
                            />
                            <div class="cart-body ps-2 pe-2 cart-body_cusor">
                                <h4 class="align-self-center cart_title mt-5 fw-bolder title_h4">.NET Core API</h4>
                                ...
                                <div class="p-3 mb-5 rounded button-ct text-uppercase" type="button">
                                    Xem chi tiết
                                </div>
                            </div>
                        </div>
