    ...
    return (
        <div className={s('wrap_baner', 'p-0','col-md-12','col-xs-12')}>
            <div className={s('baner_one','d-flex','justify-content-center')}>
                <div className={s('content_baner_one', 'col-md-9','col-xs-12','col-sm-12','d-flex','flex-column','align-items-center')}>
                    <h1 className={s('pb-5','pt-5','title_top')}>Khởi đầu sự nghiệp của bạn</h1>
                    <h1 className={s('pb-5','title_two','col-sm-12')}>Trở thành lập trình viên chuyên nghiệp tại BSMART</h1>
                ...
                <div id={carousel} className={s('container', 'd-flex', 'justify-content-between', 'hiden')}>
                    ...
                    <div className={s('item_count', 'me-1', 'p-4')}>
                        <div className={s('cart', 'border', 'shadow','col-md-3')}>
                            <img className={s('cart-img-top', 'rounded-top','col-md-3')} src={anh} alt=".NET" />
