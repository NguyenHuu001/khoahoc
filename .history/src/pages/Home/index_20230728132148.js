...
function Home() {
    ...
    return (
        <div className={s('wrap_baner', 'p-0', 'col-md-12', 'col-xs-12')}>
            ...
            <div className={s('advantages-2','container-fluid')}>
                <div className="container">
                    <div className="advantages-2-content">
                        <h4 className="text-center">Định hướng và Chuẩn hoá lộ trình học tập</h4>
                        <h2 className="text-center">Học Thật, Dự Án Thật, Mentor Tận Tâm</h2>
