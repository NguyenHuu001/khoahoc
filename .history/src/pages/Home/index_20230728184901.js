...
function Home() {
    ...
    return (
        <div className={s('wrap_baner', 'p-0', 'col-md-12', 'col-xs-12')}>
            ...
            <div className={s('wrapper')}>
                ...
                <div className={s('container', 'd-flex', 'justify-content-between', 'hiden')}>
                    ...
                    >
                        <Slider {...settings}>
                            {/* Item1 */}
                            <div className={s('col-md-3', 'col-xs-10', 'p-3')}>
            ...
            <div className={s('advantages', 'container-fluid','pb-5','pt-5')}>
                <div className={s('container')}>
                    <div className={s('advantages-content')}>
                        ...
                        <div className={s('d-flex', 'justify-content-center', 'flex-wrap')}>
                            <button className={s('button_dh', 'col-xs-12','mb-5')}>Tư vấn lộ trình</button>
                            <button className={s('button_dh', 'col-xs-12','mb-5')}>Danh sách khóa học</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className={s('wrapper_two','mt-5')}>
                <div className={s('d-flex', 'justify-content-center')}>
                    <h1 className={s('fw-bolder', 'tiltle_khoahoc')}>Nhận được sự tin tưởng của các đối tác</h1>
                </div>
                <div className={s('container', 'd-flex', 'justify-content-between', 'hiden', 'pb-5')}>
                    <div
                        className={s(
                    ...
                    >
                        <Slider {...settings}>
                            <div className={s('col-md-3','col-xs-12')}>
                                <div className={s('logo_truong1')}></div>
                            </div>
                            <div className={s('col-md-3','col-xs-12')}>
                                <div className={s('logo_truong2')}></div>
                            </div>
                            <div className={s('col-md-3','col-xs-12')}>
                                <div className={s('logo_truong3')}></div>
                            </div>
                            <div className={s('col-md-3','col-xs-12')}>
                                <div className={s('logo_truong4')}></div>
                            </div>
                            <div className={s('col-md-3','col-xs-12')}>
                                <div className={s('logo_truong5')}></div>
                            </div>
                            <div className={s('col-md-3','col-xs-12')}>
                                <div className={s('logo_truong6')}></div>
                            </div>
                            <div className={s('col-md-3','col-xs-12')}>
                                <div className={s('logo_truong7')}></div>
                            </div>
                        </Slider>
                    </div>
                </div>
            ...
            {/* Footer  */}
            <div className={s('container-fluid','footer_wrap')}>
                    ...
                    <div className={s('container')}>
                        <div className={s('row', 'd-flex', 'justify-content-between')}>
                            ...
                            <div className={s('col-sm-2', 'col-xs-5', 'col-lg-2', 'mt-5', 'p-0', 'ps-3')}>
                                <h1 className={s('title_h5')}>Menu</h1>
                                <ul className={s('ps-0', 'mt-3', 'fw-normal','text_deco')}>
                            ...
                            <div className={s('col-sm-2', 'col-xs-2', 'mt-5', 'col-lg-2', 'ms-0', 'p-0', 'ps-3')}>
                                <h1 className={s('title_h5')}>Điều khoản</h1>
                                <ul className={s('ps-0', 'mt-3', 'fw-normal','text_deco')}>
                                    <a className={s('text-decoration-none', 'text-white')} href="#">
                                ...
                                <h1 className={s('title_h5', 'mt-5')}>Cộng tác viên</h1>
                                <ul className={s('ps-0', 'mt-3', 'fw-normal','text_deco')}>
                                    <a className={s('text-decoration-none', 'text-white')} href="#">
                            ...
                            <div className={s('col-sm-4', 'col-xs-3', 'mt-5', 'col-lg-4', 'p-0', 'ps-3')}>
                                <h1 className={s('title_h5')}>Liên hệ với chúng tôi</h1>
                                ...
                                <div className={s('text-white', 'd-flex')}>
                                    ...
                                    <p className={s('fw-normal','ms-2')}>nguyenduchuu2k2@gmail.com</p>
                                </div>
                                <div className={s('text-white', 'd-flex')}>
                                    <i className="icon_info fa-solid fa-phone-volume mt-1 "></i>
                                    <p className={s('fw-normal','ms-2')}>09999........</p>
                                </div>
                            </div>
                        </div>
                    </div>
