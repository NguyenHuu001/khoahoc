                        ...
                        <Slider {...settings}>
                            <div  className={s('p-3')}>
                                <div className={s('card')}>
                                    ...
                                    <div className={s('card-body')}>
                                        <h4 className={s('card-title','card_name')}>Team STEM Mentor</h4>
                                        <p className={s('card-text','center_text')}>
                                            Xin chào mọi người, chúng tôi là giáo viên dạy STEM (khoa học, công nghệ, kỹ
                                            thuật và toán học). Chúng tôi đã có kinh nghiệm trong giảng dạy STEM trong nhiều
                                            năm và yêu thích công việc của mình. Chúng tôi rất hân hạnh được làm việc trong
                                            lĩnh vực này và hy vọng sẽ mang lại cho các em học viên những kiến thức và kỹ
                                            năng hữu ích và dẫn đến thành công trong tương lai.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div className={s('p-3')}>
                                <div className={s('card')}>
                                    <img className={s('card-img-top')} src={anh} alt="Card image" />
                                    <div className={s('card-body')}>
                                        <h4 className={s('card-title','card_name')}>Phan Nhật Tân</h4>
                                        <p className={s('card-text','center_text')}>
                                            Xin chào mọi người, chúng tôi là giáo viên dạy STEM (khoa học, công nghệ, kỹ
                                            thuật và toán học). Chúng tôi đã có kinh nghiệm trong giảng dạy STEM trong nhiều
                                            năm và yêu thích công việc của mình. Chúng tôi rất hân hạnh được làm việc trong
                            ...
                            <div className={s('p-3')}>
                                <div className={s('card')}>
                                    <img className={s('card-img-top')} src={anh} alt="Card image" />
                                    <div className={s('card-body')}>
                                        <h4 className={s('card_name')}>Phan Nhật Tân</h4>
                                        <p className={s('card-text','center_text')}>
                                            Xin chào mọi người, chúng tôi là giáo viên dạy STEM (khoa học, công nghệ, kỹ
                                            thuật và toán học). Chúng tôi đã có kinh nghiệm trong giảng dạy STEM trong nhiều
                                            năm và yêu thích công việc của mình. Chúng tôi rất hân hạnh được làm việc trong
