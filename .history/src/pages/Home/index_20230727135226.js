...
import { faCircleCheck, faFire, faGears, faQrcode, faTrophy, faUser, faUsers } from '@fortawesome/free-solid-svg-icons';
                        ...
                        <div className={s('cart', 'border', 'shadow')}>
                            ...
                            <div className={s('cart-body', 'ps-2', 'pe-2', 'cart-body_cusor')}>
                                ...
                                <a href="#" className={s('name_GV ', 'text-decoration-none', ' d-flex')}>
                                    <p className={s('ms-1', 'fw-semibold')}>Mentor </p>
                                    <p className={s('ms-2 ', 'fw-semibold')}>Trần Hữu Hiệp</p>
                                </a>
                                <div className={s('d-flex')}>
                                    <FontAwesomeIcon icon={faUser} className={s()} />
