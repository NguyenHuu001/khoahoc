            ...
            <div className={s('container-fluid', 'vantage_Point', 'p-0')}>
                    ...
                    <div className={s('container')}>
                        ...
                        <div className={s('row')}>
                            ...
                            <div className={s('col-sm-4')}>
                                <h3>Nền tảng cốt lõi trong lập trình</h3>
                                <p className={s('vantage_content')}>
                            ...
                            <div className={s('col-sm-4')}>
                                <h3>Mài giũa bạn qua thực tế</h3>
                                <p className={s('vantage_content')}>
                        ...
                        <div className={s('row')}>
                            ...
                            <div className={s('col-sm-4')}>
                                <h3>Trao tay chìa khóa thành công</h3>
                                <p className={s('vantage_content')}>
