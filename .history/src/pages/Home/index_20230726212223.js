...
function Home() {
    return (
        <div className={s('wrap_baner', 'p-0')}>
            ...
            >
                <div className={s('baner_content', 'd-flex', 'flex-column', 'align-items-center', 'col-md-12','col-xs-12', 'p-5', 'col-sm-12','col-xs-12')}>
                    <div className={s('wrap_content', 'd-flex', 'flex-column', 'align-items-center', 'col-md-12', 'col-sm-12','col-xs-12')}>
                        <h4 className={s('content_one', 'mb-5', 'col-md-12', 'col-sm-12','col-xs-12')}>Khởi đầu sự nghiệp của bạn</h4>
                        <h1 className={s('content_two', 'mb-5', 'col-md-12', 'col-sm-12','col-xs-12')}>Trở thành lập trình viên chuyên nghiệp tại BSMART</h1>
                        <p className={s('content_three', 'mb-5', 'text-wrap', 'col-md-12', 'col-sm-12','col-xs-12')}>
