...
import { faCircleCheck, faFire, faGears, faQrcode, faUsers } from '@fortawesome/free-solid-svg-icons';
            ...
            <div className={s('container-fluid', 'vantage_Point', 'p-0')}>
                <div className={s('container')}>
                    ...
                    <div className={s('row', 'set_height')}>
                        ...
                        <div className={s('col-sm-4', 'pe-5')}>
                            ...
                            <FontAwesomeIcon icon={faFire} className={s('pe-3', 'icon_check')} />
                                <h3 className={s('fw-bolder', 'vantage_title_chil','mb-0')}>Mài giũa bạn qua thực tế</h3>
                            </div>
                            <p className={s('vantage_content', 'mt-3')}>
                    ...
                    <div className={s('row', 'set_height')}>
                        ...
                        <div className={s('col-sm-4', 'pe-5')}>
                            <div className={s('wap_icon', 'd-flex','align-items-center')}>
                            <FontAwesomeIcon icon={faTr} className={s('pe-3', 'icon_check')} />
                                <h3 className={s('fw-bolder', 'vantage_title_chil','mb-0')}>Trao tay chìa khóa thành công</h3>
                            </div>
                            <p className={s('vantage_content', 'mt-3')}>
