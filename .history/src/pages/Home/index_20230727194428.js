                            ...
                            <div class="carousel-item active">
                                <div className={s('item_count', 'col-md-3', 'me-1', 'p-4')}>
                                    <div className={s('cart', 'border', 'shadow')}>
                                        <img
                                            className={s('cart-img-top', 'rounded-top', 'col-md-12')}
                                            src={anh}
                                            alt=".NET"
                                        />
                                        <div className={s('cart-body', 'ps-3', 'pe-3', 'cart-body_cusor')}>
                                            ...
                                            <div className={s('detail', 'fw-semibold')}>
                                                ...
                                                triển ứng dụng đa nền tảng, cho phép các nhà phát triển xây dựng ứng
                                                dụng trên nhiều nền tảng như Windows, macOS và Linux. Ứng dụng được phát
                                                triển bằng .NET Core API có thể hoạt động trên các nền tảng khác nhau
                                                một cách dễ dàng và không cần phải thực hiện các thủ tục phức tạp để
                                                chỉnh sửa mã nguồn.
                                            </div>
