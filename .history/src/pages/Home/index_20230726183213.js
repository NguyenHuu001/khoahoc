                    ...
                    <div className={s('container')}>
                        ...
                        <div className={s('row')}>
                            <div className={s('col-sm-4')}>
                                <h2>Học theo lộ trình, có định hướng</h2>
                            ...
                            <div className={s('col-sm-4')}>
                                <h2>Nền tảng cốt lõi trong lập trình</h2>
                                <p className={s('vantage_content')}>
                            ...
                            <div className={s('col-sm-4')}>
                                <h2>Mài giũa bạn qua thực tế</h2>
                                <p className={s('vantage_content')}>
                        ...
                        <div className={s('row')}>
                            ...
                            <div className={s('col-sm-4')}>
                                <h2>Trao tay chìa khóa thành công</h2>
                                <p className={s('vantage_content')}>
