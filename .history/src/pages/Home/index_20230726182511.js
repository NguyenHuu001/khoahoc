            ...
            <div className={s('container-fluid', 'vantage_Point', 'p-0')}>
                ...
                <div classNames={s('container')}>
                    <div classNames={s('row')}>
                        ...
                        <div classNames={s('col-sm-4')}>
                            <h1>Nền tảng cốt lõi trong lập trình</h1>
                            <p classNames={s('vantage_content')}>
                        ...
                        <div classNames={s('col-sm-4')}>
                            <h1>Mài giũa bạn qua thực tế</h1>
                            <p classNames={s('vantage_content')}>
                    ...
                    <div classNames={s('row')}>
                        ...
                        <div classNames={s('col-sm-4')}>
                            <h1>Trao tay chìa khóa thành công</h1>
                            <p classNames={s('vantage_content')}>
