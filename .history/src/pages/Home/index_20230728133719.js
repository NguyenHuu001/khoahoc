            ...
            <div className={s('advantages','container-fluid')}>
                <div className={s('container')}>
                    <div className={s('advantages-content')}>
                        <h4 className={s('text-center','title_dinhuong','fw-bolder')}>Định hướng và Chuẩn hoá lộ trình học tập</h4>
                        <h2 className={s('text-center','fw-bolder','title_dinhuong1')}>Học Thật, Dự Án Thật, Mentor Tận Tâm</h2>
                        <div className={s('d-flex','justify-content-center')}>
                            <div href="#" className={s('button')}>
                            <button className={s('')}>Danh sách khóa học</button>
                            </div>

                            <div href="#">
                                <button className={s('button')}>Tư vấn lộ trình</button>
                            </div>
                        </div>
                    </div>
                </div>
