...
function Home() {
    ...
    return (
        <div className={s('wrap_baner', 'p-0')}>
            <div className={s('baner_one')}>
                <div className={s('content_baner_one','col-md-12')}>
                        <h1>KHỞI ĐẦU SỰ NGHIỆP CỦA BẠN</h1>
                        <h1>Trở thành lập trình viên chuyên nghiệp tại BSMART</h1>
                        <span>Với đội ngũ Mentor có nhiều năm kinh nghiệm giảng dạy cùng các khóa học chất lượng. BSMART sẽ giúp các bạn có định hướng về nghề nghiệp và phát triển bản thân trên con đường trở thành lập trình viên chuyên nghiệp</span>
                </div>
            </div>
            {/* Về chúng tôi */}
