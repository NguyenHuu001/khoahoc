...
function Home() {
    ...
    return (
        < className={s('wrap_baner', 'p-0', 'col-md-12', 'col-xs-12')}>
            ...
            <div class="footer_wrap">
                <div class="container ">
                    <div class="row d-flex justify-content-between">
                        <div class="col-sm-5 col-xs-12 col-lg-3 mt-5 p-0 ps-3">
                            <img class="mb-5 " src="img/sv_logo_dashboard.png" alt=""/>
                            <p class="text-white mb-5 text-wrap">Chúng tôi cung cấp các khoá học chất lượng cao để
                                cải thiện các kỹ năng lập trình của bạn. Tất cả các mentor của chúng
                                tôi đều có nhiều kinh nghiệm trong thực tế và giảng dạy.
                            </p>
                            <h5 class="text-white mb-2">Theo dõi chúng tôi tại:</h5>
                            <div class="wrap_icon mb-5 ">
                                <a class="me-2" href="#"><i class="fa-brands fa-facebook"
                                        style="color: #eff0f0;"></i></a>
                                <a class="me-2" href=""><i class="fa-brands fa-square-instagram"
                                        style="color: #fcfcfd;"></i></a>
                                <a class="me-2" href="#"><i class="fa-brands fa-youtube"
                                        style="color: #fcfcfc;"></i></a>
                            </div>
                        </div>
                        <div class="col-sm-2 col-xs-5 col-lg-2 mt-5 p-0 ps-3">
                            <h5 class="title_h5 ">Menu</h5>
                            <ul class="ps-0 mt-3 fw-normal " style="list-style: none;">
                                <a class="text-decoration-none text-white" href="#">
                                    <li class="mt-2">Trang chủ</li>
                                </a>
                                <a class="text-decoration-none text-white" href="#">
                                    <li class="mt-2">Về chúng tôi</li>
                                </a>
                                <a class="text-decoration-none text-white" href="#">
                                    <li class="mt-2">Nền tảng LMS</li>
                                </a>
                                <a class="text-decoration-none text-white" href="#">
                                    <li class="mt-2">Khóa học STEM</li>
                                </a>
                                <a class="text-decoration-none text-white" href="#">
                                    <li class="mt-2">Khóa học</li>
                                </a>
                                <a class="text-decoration-none text-white" href="#">
                                    <li class="mt-2">Mentor</li>
                                </a>
                                <a class="text-decoration-none text-white" href="#">
                        ...
                        <div class="col-sm-2 col-xs-2 mt-5 col-lg-2 ms-0 p-0 ps-3">
                            <h5 class="title_h5 ">Điều khoản</h5>
                            <ul class="ps-0 mt-3 fw-normal" style="list-style: none;">
                                <a class="text-decoration-none text-white" href="#">
                                    <li class="mt-2">Chính sách bảo mật</li>
                                </a>
                                <a class="text-decoration-none text-white" href="#">
                                    <li class="mt-2">Điều khoản dịch vụ</li>
                                </a>
                            </ul>
                            <h5 class="title_h5  mt-5">Cộng tác viên</h5>
                            <ul class="ps-0 mt-3 fw-normal " style="list-style: none;">
                                <a class="text-decoration-none text-white" href="#">
                                    <li class="mt-2">Đăng ký Cộng tác viên</li>
                                </a>
                                <a class="text-decoration-none text-white" href="#">
                                    <li class="mt-2">Đăng ký Mentor</li>
                                </a>
                            </ul>
                        </div>
                        <div class="col-sm-4 col-xs-3 mt-5 col-lg-4 p-0 ps-3">
                            <h5 class="title_h5">Liên hệ với chúng tôi</h5>
                            <div class="text-white d-flex ">
                                <i class="icon_info fa-solid fa-location-dot mt-1"></i>
                                <p class="fw-normal ms-2">Tân Phú, TP.HCM</p>
                            </div>
                            <div class="text-white d-flex ">
                                <i class="icon_info fa-solid fa-envelope mt-2"></i>
                                <p class="fw-normal ms-2">nguyenduchuu2k2@gmail.com</p>
                            </div>
                            <div class="text-white d-flex ">
                                <i class="icon_info fa-solid fa-phone-volume mt-1 "></i>
                                <p class="fw-normal ms-2">09999........</p>
                            </div>
