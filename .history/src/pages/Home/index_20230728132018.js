            ...
            <section class="advantages-2">
                <div class="container">
                    <div class="advantages-2-content">
                        <h4 class="text-center">Định hướng và Chuẩn hoá lộ trình học tập</h4>
                        <h2 class="text-center">Học Thật, Dự Án Thật, Mentor Tận Tâm</h2>
                        <div class="d-flex justify-content-center">
                            <a href="/course" class="btn btn-primary-custom-select m-2">
                                Danh sách khoá học
                            </a>

                            <a href="#">
                                <button class="btn btn-outline-secondary-custom m-2">Tư vấn lộ trình</button>
                            </a>
                        </div>
                    </div>
                </div>
