                ...
                <div className={s('sidebar_content')}>
                    ...
                    <div className={s('sidebar_menu ')}>
                        <ul>
                            ...
                            <li className={s('text-uppercase','pt-3')}>Khóa học stem</li>
                            <li className={s('text-uppercase','pt-3')}>Khóa học</li>
                            <li className={s('text-uppercase','pt-3')}>mentor</li>
                            <li className={s('text-uppercase','pt-3')}>blog</li>
                        </ul>
                    </div>
